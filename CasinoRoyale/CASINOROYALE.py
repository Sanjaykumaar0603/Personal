...
connection_object=sq.connect(host='localhost',user='root',passwd='1234')
cursor_object=connection_object.cursor(buffered=True)
cursor_object.execute('create database if not exists casinoroyale')
cursor_object.execute('use casinoroyale')
cursor_object.execute('create table if not exists pca(Name varchar(40),starting_balance int(50),current_balance int(50),Games_played int(10))')
cursor_object.execute('create table if not exists slots(Sno int(5),Balance int(50))')
cursor_object.execute('create table if not exists roulette(Sno int(5),Balance int(50))')
cursor_object.execute('create table if not exists craps(Sno int(5),Balance int(50))')
cursor_object.execute('create table if not exists scratchcards(Sno int(5),Balance int(50))')
cursor_object.execute('create table if not exists sb(Name varchar(40),Starting_balance int(50),Ending_balance int(50),Games_played int(10))')
def get_input():
    secondpage.destroy()
    global name
    global startamt
    ...
    currentamt=startamt
    Sno=1
    cursor_object.execute("insert into pca values('%s',%d,%d,0)"%(name,startamt,currentamt))
...
def lastpage():
    global page5
    page5=tk.Tk()
    lb=Label(page5,text='LEADER BOARD:',bg='black',fg='white',bd=0)
    lb.place(x=10,y=40)
    cursor_object.execute("select current_balance from pca where Name='%s'"%name)
    curramm5=cursor_object.fetchone()
    connection_object.commit()
    global curamm5
    curamm5=curramm5[0]
    cursor_object.execute("select Games_played from pca where Name='%s'"%name)
    gamesplayed2=cursor_object.fetchone()
    connection_object.commit()
    gameplay=gamesplayed2[0]
    page5.title('Game over')
    page5.geometry('800x500')
    page5.configure(bg='Black')
    cursor_object.execute("insert into sb values('%s',%s,%s,%s)"%(name,startamt,curamm5,gameplay))
    connection_object.commit()
    ...
    cursor_object.execute('select * from sb order by Ending_balance desc')
    a=cursor_object.fetchall()
    connection_object.commit()
    result1=Label(page5,text='1',fg='white',bg='black',bd=0,font='bold')
    result1.place(x=30,y=135)
    result2=Label(page5,text=a[0][0],bg='black',fg='white',bd=0,font='bold')
    result2.place(x=132,y=135)
    result3=Label(page5,text=str(a[0][1]),bg='black',fg='white',bd=0,font='bold')
    result3.place(x=295,y=135)
    result4=Label(page5,text=str(a[0][2]),bg='black',fg='white',bd=0,font='bold')
    result4.place(x=480,y=135)
    result5=Label(page5,text=str(a[0][3]),bg='black',fg='white',bd=0,font='bold')
    result5.place(x=670,y=135)
    try:
        result10=Label(page5,text='2',fg='white',bg='black',bd=0,font='bold')
        result10.place(x=30,y=165)
        result20=Label(page5,text=a[1][0],bg='black',fg='white',bd=0,font='bold')
        result20.place(x=132,y=165)
        result30=Label(page5,text=str(a[1][1]),bg='black',fg='white',bd=0,font='bold')
        result30.place(x=295,y=165)
        result40=Label(page5,text=str(a[1][2]),bg='black',fg='white',bd=0,font='bold')
        result40.place(x=480,y=165)
        result50=Label(page5,text=str(a[1][3]),bg='black',fg='white',bd=0,font='bold')
        result50.place(x=670,y=165)
    except:
        pass
    try:
        result11=Label(page5,text='3',fg='white',bg='black',bd=0,font='bold')
        result11.place(x=30,y=195)
        result21=Label(page5,text=a[2][0],bg='black',fg='white',bd=0,font='bold')
        result21.place(x=132,y=195)
        result31=Label(page5,text=str(a[2][1]),bg='black',fg='white',bd=0,font='bold')
        result31.place(x=295,y=195)
        result41=Label(page5,text=str(a[2][2]),bg='black',fg='white',bd=0,font='bold')
        result41.place(x=480,y=195)
        result51=Label(page5,text=str(a[2][3]),bg='black',fg='white',bd=0,font='bold')
        result51.place(x=670,y=195)
    except:
        pass
    try:
        result12=Label(page5,text='4',fg='white',bg='black',bd=0,font='bold')
        result12.place(x=30,y=225)
        result22=Label(page5,text=a[3][0],bg='black',fg='white',bd=0,font='bold')
        result22.place(x=132,y=225)
        result32=Label(page5,text=str(a[3][1]),bg='black',fg='white',bd=0,font='bold')
        result32.place(x=295,y=225)
        result42=Label(page5,text=str(a[3][2]),bg='black',fg='white',bd=0,font='bold')
        result42.place(x=480,y=225)
        result52=Label(page5,text=str(a[3][3]),bg='black',fg='white',bd=0,font='bold')
        result52.place(x=670,y=225)
    except:
        pass
    try:
        result13=Label(page5,text='5',fg='white',bg='black',bd=0,font='bold')
        result13.place(x=30,y=255)
        result23=Label(page5,text=a[4][0],bg='black',fg='white',bd=0,font='bold')
        result23.place(x=132,y=255)
        result33=Label(page5,text=str(a[4][1]),bg='black',fg='white',bd=0,font='bold')
        result33.place(x=295,y=255)
        result43=Label(page5,text=str(a[4][2]),bg='black',fg='white',bd=0,font='bold')
        result43.place(x=480,y=255)
        result53=Label(page5,text=str(a[4][3]),bg='black',fg='white',bd=0,font='bold')
        result53.place(x=670,y=255)
    except:
        pass
    try:
        result14=Label(page5,text='6',fg='white',bg='black',bd=0,font='bold')
        result14.place(x=30,y=285)
        result24=Label(page5,text=a[5][0],bg='black',fg='white',bd=0,font='bold')
        result24.place(x=132,y=285)
        result34=Label(page5,text=str(a[5][1]),bg='black',fg='white',bd=0,font='bold')
        result34.place(x=295,y=285)
        result44=Label(page5,text=str(a[5][2]),bg='black',fg='white',bd=0,font='bold')
        result44.place(x=480,y=285)
        result54=Label(page5,text=str(a[5][3]),bg='black',fg='white',bd=0,font='bold')
        result54.place(x=670,y=285)
    except:
        pass
    try:
        result15=Label(page5,text='7',fg='white',bg='black',bd=0,font='bold')
        result15.place(x=30,y=315)
        result25=Label(page5,text=a[6][0],bg='black',fg='white',bd=0,font='bold')
        result25.place(x=132,y=315)
        result35=Label(page5,text=str(a[6][1]),bg='black',fg='white',bd=0,font='bold')
        result35.place(x=295,y=315)
        result45=Label(page5,text=str(a[6][2]),bg='black',fg='white',bd=0,font='bold')
        result45.place(x=480,y=315)
        result55=Label(page5,text=str(a[6][3]),bg='black',fg='white',bd=0,font='bold')
        result55.place(x=670,y=315)
    except:
        pass
    try:
        result16=Label(page5,text='8',fg='white',bg='black',bd=0,font='bold')
        result16.place(x=30,y=345)
        result26=Label(page5,text=a[7][0],bg='black',fg='white',bd=0,font='bold')
        result26.place(x=132,y=345)
        result36=Label(page5,text=str(a[7][1]),bg='black',fg='white',bd=0,font='bold')
        result36.place(x=295,y=345)
        result46=Label(page5,text=str(a[7][2]),bg='black',fg='white',bd=0,font='bold')
        result46.place(x=480,y=345)
        result56=Label(page5,text=str(a[7][3]),bg='black',fg='white',bd=0,font='bold')
        result56.place(x=670,y=345)
    except:
        pass    
    if startamt<curamm5 and curamm5>0:
        ...
        gr01=Label(page5,text=str(curamm5),fg='white',bg='black',bd=0,font='Arial')
    ...
    if startamt>=curamm5 and curamm5>=0:
        ...
        gr010=Label(page5,text=str(curamm5),fg='white',bg='black',bd=0,font='Arial')
...
def winnerroll1():
    ...
    if onpos==opdies:
        ...
        cursor_object.execute("update craps set Balance=Balance+%s where Sno=%s"%(int(entryamt3)*4,Sno))
        connection_object.commit()
...
def roll02():
    global entryamt1
    entryamt1=ins1.get()
    cursor_object.execute("update slots set Balance=Balance-%s where Sno=%s"%(int(entryamt1),Sno))
    connection_object.commit()
    ...
    if pic1==pic2 and pic2==pic3:
        ...
        cursor_object.execute("update slots set Balance=Balance+%s where Sno=%s"%(int(entryamt1)*10,Sno))
        connection_object.commit()             
def roll2():
    global entryamt2
    entryamt2=ins2.get()
    cursor_object.execute("update roulette set Balance=Balance-%s where Sno=%s"%(int(entryamt2),Sno))
    connection_object.commit()   
    global rroll0
    ...
    if rroll0==selected:
        info4.destroy()
        cursor_object.execute("update roulette set Balance=Balance+%s where Sno=%s"%(int(entryamt2)*6,Sno))
        connection_object.commit()
    else:
        info7.destroy()
...
def roll3():
    global entryamt3
    entryamt3=ins3.get()
    cursor_object.execute("update craps set Balance=Balance-%s where Sno=%s"%(int(entryamt3),Sno))
    connection_object.commit()
    global croll1
...
def roll04():
    global entryamt4
    entryamt4=ins4.get()
    cursor_object.execute("update scratchcards set Balance=Balance-%s where Sno=%s"%(int(entryamt4),Sno))
    connection_object.commit()
def slotscommand():
    try:
        cursor_object.execute("select Balance from slots where Sno=%s"%Sno)
        sua=cursor_object.fetchone()
        cursor_object.execute("update pca set current_balance=%s "%sua)
        connection_object.commit()
    except:
        pass
    cursor_object.execute("update pca set Games_played=%s "%gamesplayed)
    connection_object.commit() 
    try:
        cursor_object.execute('delete from slots')
        connection_object.commit()
    except:
        pass
    page1.destroy()
...
def roulettecommand():
    try:
        cursor_object.execute("select Balance from roulette where Sno=%s"%Sno)
        sua2=cursor_object.fetchone()
        cursor_object.execute("update pca set current_balance=%s "%sua2)
        connection_object.commit()
    except:
        pass
    cursor_object.execute("update pca set Games_played=%s "%gamesplayed)
    connection_object.commit()
    try:
        cursor_object.execute('delete from roulette')
        connection_object.commit()
    except:
        pass
    page2.destroy()
...
def crapscommand():
    try:
        cursor_object.execute("select Balance from craps where Sno=%s"%Sno)
        sua3=cursor_object.fetchone()
        cursor_object.execute("update pca set current_balance=%s "%sua3)
        connection_object.commit()
    except:
        pass
    cursor_object.execute("update pca set Games_played=%s "%gamesplayed)
    connection_object.commit()
    try:
        cursor_object.execute('delete from craps')
        connection_object.commit()
    except:
        pass
    page3.destroy()
...
def scratchcardcommand():
    try:
        cursor_object.execute("select Balance from scratchcards where Sno=%s"%Sno)
        sua4=cursor_object.fetchone()
        cursor_object.execute("update pca set current_balance=%s "%sua4)
        connection_object.commit()
    except:
        pass
    cursor_object.execute("update pca set Games_played=%s "%gamesplayed)
    connection_object.commit()
    try:
        cursor_object.execute('delete from scratchcards')
        connection_object.commit()
    except:
        pass
    page4.destroy()
...
def card1():
    ...
    if len(cardlist)==3:
        if cardlist[0]==cardlist[1] and cardlist[1]==cardlist[2]:
            scbg4.destroy()
            cursor_object.execute("update scratchcards set Balance=Balance+%s where Sno=%s"%(int(entryamt4)*4,Sno))
            connection_object.commit()
        else:
            scbg6.destroy()
def card2():
...
def slots():
    ...
    cursor_object.execute("select current_balance from pca where Name='%s'"%name)
    curramm=cursor_object.fetchone()
    connection_object.commit()
    fourthpage.destroy()
    global curamm
    curamm=curramm[0]
    cursor_object.execute("insert into slots values(%s,%s)"%(Sno,int(curamm)))
    connection_object.commit()
    page01=tk.Tk()
...
def roulette():
    ...
    gamesplayed=gamesplayed+1
    cursor_object.execute("select current_balance from pca where Name='%s'"%name)
    curramm2=cursor_object.fetchone()
    connection_object.commit()
    global curamm2
    curamm2=curramm2[0]
    cursor_object.execute("insert into roulette values(%s,%s)"%(Sno,int(curamm2)))
    connection_object.commit()
    fourthpage.destroy()
    page02=tk.Tk()
...
def craps():
    ...
    gamesplayed+=1
    cursor_object.execute("select current_balance from pca where Name='%s'"%name)
    curramm3=cursor_object.fetchone()
    connection_object.commit()
    global curamm3
    curamm3=curramm3[0]
    cursor_object.execute("insert into craps values(%s,%s)"%(Sno,int(curamm3)))
    connection_object.commit()
    fourthpage.destroy()
    page03=tk.Tk()
...
def scratchcards():
    ...
    gamesplayed=gamesplayed+1
    cursor_object.execute("select current_balance from pca where Name='%s'"%name)
    curramm4=cursor_object.fetchone()
    connection_object.commit()
    global curamm4
    curamm4=curramm4[0]
    cursor_object.execute("insert into scratchcards values(%s,%s)"%(Sno,int(curamm4)))
    connection_object.commit()
    fourthpage.destroy()
    page04=tk.Tk()
...
def gameover():
    page5.destroy()
    cursor_object.execute('delete from pca')
    connection_object.commit()
    cursor_object.close()
